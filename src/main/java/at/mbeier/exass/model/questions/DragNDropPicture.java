...
public class DragNDropPicture extends Question {

    //TODO implement

    public DragNDropPicture() {
        super();
    }

    public DragNDropPicture(String name, String text, int points) {
        super(QuestionType.DRAG_N_DROP_PIC, name, text, points);
    }
